...
var file_http_server_health_health_proto_goTypes = []interface{}{
	(*HealthCheckRequest)(nil),  // 0: bricks.health.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil), // 1: bricks.health.v1.HealthCheckResponse
}
var file_http_server_health_health_proto_depIdxs = []int32{
	0, // 0: bricks.health.v1.Health.Check:input_type -> bricks.health.v1.HealthCheckRequest
	1, // 1: bricks.health.v1.Health.Check:output_type -> bricks.health.v1.HealthCheckResponse
