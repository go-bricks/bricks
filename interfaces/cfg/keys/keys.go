...
const (
	...
	//
	// Type: string
	ApplicationName string = bricks + ".name"

	// Webserver specific configurations
	server = bricks + ".server"
	// Bricks Logger configuration
	logger = bricks + ".logger"
	// Bricks monitoring configuration
	monitor = bricks + ".monitor"
	// Bricks middleware, interceptors
	middleware = bricks + ".middleware"
	// Bricks bundled handlers
	handlers = bricks + ".handlers"
)
...
// Logger related keys
const (
	// LogLevel set the default log level for bricks logger
	// Possible values:
