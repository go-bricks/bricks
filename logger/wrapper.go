...
const (
	compensateBricksLoggerWrapper = 1
)
...
// CreateBricksLogger creates a new bricks logger which is a wrapper to support
//   - ContextExtractors
//
// **Important**
//
//	This constructor will call builder.IncrementSkipFrames to peel additional layer of itself.
func CreateBricksLogger(builder log.Builder, contextExtractors ...log.ContextExtractor) log.Logger {
	logger := builder.IncrementSkipFrames(compensateBricksLoggerWrapper).Build() // add 1
