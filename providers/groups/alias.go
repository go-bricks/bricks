...
const (
	// RESTClientInterceptors - REST Client Interceptors group. This group will help you configure Bricks default REST Client builder
	RESTClientInterceptors = partial.FxGroupRESTClientInterceptors

	// GRPCUnaryClientInterceptors - GRPC Unary Client Interceptors group. This group will help you configure Bricks default GRPC Client builder
	GRPCUnaryClientInterceptors = partial.FxGroupGRPCUnaryClientInterceptors

	// GRPCServerAPIs - Bricks GRPC Service APIs group. This group is responsible on registering your gRPC server implementation
	...
	// InternalHTTPHandlers - Internal Http Handlers group. Bricks comes with several internal handlers, you can add yours.
