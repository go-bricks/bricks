...
// BuildBricksWebServiceFxOption creates the entire dependency graph
...
// by calling BuildBricksWebServiceFxOption fx.Invoke option to the graph
...
// List of prefixes is controlled by config key: `bricks.middleware.map.httpHeaders`
